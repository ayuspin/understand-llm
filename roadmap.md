...
## Phase 2: Sequential Understanding (Next 🚀)
...
- [ ] **Multi-Head Attention**: Learning different types of relationships simultaneously (e.g., one head for grammar, one for sentiment).
...
- [ ] **Softmax**: Turning raw scores (Logits) into clean probabilities.
